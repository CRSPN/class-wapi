...
var taskFormHandler = function(event) {
    ...
    if (!taskNameInput || !taskTypeInput) {
        alert("You need to fill out the tast form!");
        return false;
    }
    formEl.reset();
...
var dropTaskHandler = function(event) {
    ...
    dropZoneEl.removeAttribute("style");6
...
var loadTasks = function() {
    ...
    for (var i = 0;i < tasks.length; i++ ) {
        ...
        var listItemEl = document.createElement("li");
        listItemEl.className = "task-item";
        listItemEl.setAttribute("data-task-id", tasks);
        listItemEl.setAttribute("draggable", "true");
    ...
    console.log(tasks);
    //convert tasks from stringified back into array of obj.

    //iterate through tasks arr & creates task elements on page
